...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="ButtonAddNewHorse" runat="server" Text="Add New" onclick="ButtonAddNewHorse_Click" />
    <asp:Panel ID="PanelHorseDetails" runat="server" Visible="False">
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxHorseWeight" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="TextBoxHorseSize" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxHorseRidingSchool" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="TextBoxHorseShowJumping" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="TextBoxHorseDressage" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="TextBoxHorseRacing" runat="server"></asp:TextBox>
                </td>
            </tr>
        </table>
